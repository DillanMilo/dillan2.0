      ...
      >
        {socialLinks.map((handle, index) => (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-2xl sm:text-3xl md:text-5xl font-bebas text-red-600 transition-all duration-300 hover:text-red-400 whitespace-nowrap [filter:drop-shadow(-0.5px_-0.5px_0px_white)_drop-shadow(0.5px_-0.5px_0px_white)_drop-shadow(-0.5px_0.5px_0px_white)_drop-shadow(0.5px_0.5px_0px_white)]"
          >
            {handle.name}
          </a>
        ))}
